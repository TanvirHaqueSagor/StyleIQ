...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  List<SubscriptionPlan> get _availablePlans => SubscriptionCapabilityService.catalog();
              ...
              Container(
                ...
                child: const Text(
                  ...
                  style: TextStyle(
                    ...
                    color: AppTheme.amber, letterSpacing: 0.3,
                  ),
                ),
              ),
            ],
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: isSelected ? accent : AppTheme.darkBorder,
